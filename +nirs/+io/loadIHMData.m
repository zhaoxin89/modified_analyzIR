            ...
            for z=[1:1:6]
                for x=[1:1:5]
                    for g=[1:1:14]
                        ...
                        if length(d{hemi,z}{x,g})>length(d{hemi,7}{5,14})
                            d{hemi,z}{x,g}=d{hemi,z}{x,g}(1:length(d{hemi,z}{x,g})-1);
                            d{hemi,7}{x,g}=d{hemi,7}{x,g}(1:length(d{hemi,z}{x,g}));
                        end
                        d{hemi,z}{x,g}(1,:)=d{hemi,z}{x,g}(1,:)-d{hemi,7}{x,g}(1,:); 
                    end
                end
            end
            d1 = [];
